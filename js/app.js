...
function carregaListaDespesas(despesas = Array (), filtro = false) {
    ...
    if(despesas == '') {
        document.getElementById('null').innerHTML = `Nenhum cadastro foi localizado <br> pesquise novamente`
    } else {
        document.getElementById('null').innerHTML = `Lista de cadastrados localizadas`
    }

    //selecionando o elemento tbody da tabela
    let listaDespesas = document.getElementById('listaDespesas')
    //deixar vazio depois da pesquisa
